...
st.title('Japanese Wage Dashbord')
st.markdown('日本の平均賃金の推移を分析するためのダッシュボードです')
...
st.header('2022年:一人当たりの平均賃金ヒートマップ')
...
df_pref_map = pd.merge(df_pref_map, jp_lat_lon, on='都道府県名') #明示的にキーを示す
